...
class deduplicator_helper(object):
    ...
    def calculate_address_score(self,address1,address2):
        ...
        address_score = 50
        address1.MUNICIPALITY = address1.MUNICIPALITY.replace('Ã‘','n')
        address2.MUNICIPALITY = address2.MUNICIPALITY.replace('Ã‘','n')
        address1.BARANGAY = address1.BARANGAY.replace('Ã‘','n')
        address2.BARANGAY = address2.BARANGAY.replace('Ã‘','n')
