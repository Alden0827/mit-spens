...
insert  into `auth_user`(`id`,`password`,`last_login`,`is_superuser`,`username`,`first_name`,`last_name`,`email`,`is_staff`,`is_active`,`date_joined`) values (4,'pbkdf2_sha256$720000$vNDl5BpUDeeUhXPKOTOEVw$YZs3xBNn80I1i+hLaHzJ6UbLi/58LuYoyUsg8bHZk6w=','2025-03-06 08:56:31.578393',0,'user01','Alden','Quinones','user01@gmail.com',0,1,'2025-03-02 07:09:29.309544');
...
insert  into `django_session`(`session_key`,`session_data`,`expire_date`) values ('pt1chmfr17vtluonh00qszqvfm9a7663','.eJxVjEEOwiAQRe_C2hBgpkBduvcMZIBBqoYmpV0Z765NutDtf-_9lwi0rTVsnZcwZXEWKE6_W6T04LaDfKd2m2Wa27pMUe6KPGiX1znz83K4fweVev3WNOBgHERjLaaMbjSFGJXSXJT26AyPniECaW8joHKkMgBaDbZQKiDeH79-NwM:1tq71r:Q-HPNauZjX5sr0p57BSExnQQPCVuHcvki6ym_tYWZxQ','2025-03-07 08:56:31.581362');
