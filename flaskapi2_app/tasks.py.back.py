...
def deduplicate(self, threshold, subset):
    ...
    with app.app_context():
        ...
        def deduplicate_commence(threshold):
            ...
            try:
                ...
                dq = deduplicator_helper(threshold=threshold, checkpoint_segment=1000, update_state=self.update_state)
        ...
        deduplicate_commence(threshold)
